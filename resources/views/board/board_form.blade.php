                ...
                <form method="POST" name="form" action="{{ route('board_confirm') }}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="board_name" id="board_name" placeholder="{{ __('wording.board_name') }}" value="{{ old('board_name') ?? $board_name ?? ''}}">
                        </div>
                        <div class="form-group">
                            <label for="board_description">{{ __('wording.board_description') }}</label>
                            <textarea id="board_description" name="description" class="form-control" rows="5">{{ old('description') ?? $description ?? ''}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="card-footer">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 text-center">
                                ...
                                <input type="hidden" name="hash_key" value="{{ old('hash_key') ?? $hash_key ?? '' }}">
                            </div>
                            <div class="col-md-3"></div>
                        </div>
                    </div>
